  ...
  return (
    <div>
      ...
      <address>
        ...
        <br/>
          <time datetime="2018-09-22">November 22, 2018</time>
      </address>

      <br/>
      <span>The Statue of Liberty's original torch is getting a new home.</span>
      ...
      <p><q>Although it is not one of the most difficult things we have ever moved,</q> says Douglas Phelps, who oversaw the relocation of the torch, "it is certainly the most important."</p>

      <h1>The history of the Statue of Liberty</h1>

      <p>Not only is the Statue of Liberty the symbol of New York City, she is also a UNESCO World Heritage site May
        under the designation of <i>Outstanding Universal Value</i>.</p>
      ...
      * Total overall height from the base of the pedestal foundation to the tip of the torch is <strong>305 feet, 6 inches</strong>
      <br/>
      * Height of the Statue from her heel to the top of her head is 111 feet, 6 inches
      <br/>
      * The Statue has a <strong>35-foot</strong> waistline
      <br/>
      * Total weight of the Statue of Liberty is <strong>225 tons (or 450,000 pounds)</strong>
    </div>
  )
}
